...
* Installation
  ...
  Go-template source files use ~poly-any-go-template~ while retaining the
  target file's host mode. Install it from [[https://github.com/chuxubank/poly-any-template][poly-any-template]] alongside this package.
